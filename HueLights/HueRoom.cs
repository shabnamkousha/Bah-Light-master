...
namespace HueLights
{
    public class HueRoom
    {
        ...
        public ushort RoomBulbNum;
        public ushort RoomOnline;
        public string[] SceneName = new string[20];
        public string[] SceneId = new string[20];
        public string[] LampName = new string[20];
        public string[] LampNameId = new string[20];
	    ...
	    public void RoomInit()
	    {
		    ...
		    if (HueBridge.Populated == true)
		    {
			    ...
			    if (_foundroom)
			    {
                    ...
                    RoomBulbNum = (ushort) HueBridge.HueGroups[RoomId - 1].Loads.Length;
                    for (int j = 0; j < RoomBulbNum; j++)
                    { 
                        LampNameId[j] = HueBridge.HueGroups[RoomId - 1].Loads[j];
                        LampName[j]= HueBridge.HueBulbs[Int32.Parse(LampNameId[j])-1].Name;
                    }
