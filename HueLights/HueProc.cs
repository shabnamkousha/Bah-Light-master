...
namespace HueLights
{
    public class HueProc
    {
        ...
        public void getRoomsBulbs()
        {
            RoomNumber = HueBridge.HueGroups[0].Loads[0];
        ...
        public void ProcScenes(string jsondata)
        {
            ...
            {
				JObject json = JObject.Parse(jsondata);
                CrestronConsole.PrintLine("Printing ************************");
                CrestronConsole.PrintLine("Loads Data: {0} ", HueBridge.HueGroups[0].Name);
                CrestronConsole.PrintLine("Loads Data: {0} ", HueBridge.HueGroups[0].Loads[0]);
                CrestronConsole.PrintLine("Loads Data: {0} ", HueBridge.HueGroups[0].Loads[1]);
                CrestronConsole.PrintLine("Printing ************************");
                CrestronConsole.PrintLine("Loads Data: {0} ", HueBridge.HueGroups[1].Name);
                CrestronConsole.PrintLine("Loads Data: {0} ", HueBridge.HueGroups[1].Loads[0]);
                CrestronConsole.PrintLine("Loads Data: {0} ", HueBridge.HueGroups[1].Loads[1]);
                CrestronConsole.PrintLine("Printing ************************");
                CrestronConsole.PrintLine("Loads Data: {0} ", HueBridge.HueGroups[2].Name);
                CrestronConsole.PrintLine("Loads Data: {0} ", HueBridge.HueGroups[2].Loads[0]);
                CrestronConsole.PrintLine("Loads Data: {0} ", HueBridge.HueGroups[2].Loads[1]);
                CrestronConsole.PrintLine("Printing ************************");
                CrestronConsole.PrintLine("Lamp Name: {0} ", HueBridge.HueBulbs[0].Name);
                CrestronConsole.PrintLine("Lamp Name: {0} ", HueBridge.HueBulbs[1].Name);
                CrestronConsole.PrintLine("Lamp Name: {0} ", HueBridge.HueBulbs[2].Name);
                CrestronConsole.PrintLine("Lamp Name: {0} ", HueBridge.HueBulbs[3].Name);
                CrestronConsole.PrintLine("Lamp Name: {0} ", HueBridge.HueBulbs[4].Name);
                CrestronConsole.PrintLine("Lamp Name: {0} ", HueBridge.HueBulbs[5].Name);
